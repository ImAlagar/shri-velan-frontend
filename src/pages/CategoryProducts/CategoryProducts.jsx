...
const CategoryProducts = () => {
  ...
  // FIXED: Comprehensive data extraction with detailed logging
  const categories = categoriesResponse?.data || [];
  
  // FIXED: Try multiple possible data structures
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm sm:text-base">
                ...
                {allProducts.filter(p => p.categoryId === categoryId).length !== filteredProducts.length && 
                  ` (from ${allProducts.filter(p => p.categoryId === categoryId).length} total in category)`
                }
              </p>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className={`lg:w-80 ${showFilters ? 'block' : 'hidden lg:block'}`}>
            <div className="space-y-6">
              ...
              {/* Filters Section - Only show if we have products */}
              ...
              >
                ...
                <p className="text-gray-600 mb-6">
                  {allProducts.length === 0 
                    ...
                    : allProducts.filter(p => p.categoryId === categoryId).length === 0 
